...
/*   Updated: 2023/02/27 01:20:58 by zmoussam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{   
  map[0] =  ft_strdup("11111111111111111111111111111111");
   map[1] =  ft_strdup("10000000000001000000001000001001");
   map[2] =  ft_strdup("10000000000001000000001000001001");
   map[3] =  ft_strdup("10011111111001001111001001001001");
   map[4] =  ft_strdup("10010000001000000001000001001001");
   map[5] =  ft_strdup("10010000001000000001000001001001");
   map[6] =  ft_strdup("10010011111111001111111111001001");
   map[7] =  ft_strdup("10010010000001001000000000001001");
   map[8] =  ft_strdup("10010010000001001000000000001001");
   map[9] =  ft_strdup("10010010001001111001111111111001");
   map[10] = ft_strdup("10000010001000001000001000001001");
   map[11] = ft_strdup("11110010001000001000001000001001");
   map[12] = ft_strdup("10000010001111001111001001001001");
   map[13] = ft_strdup("10000010000001001001101001000001");
   map[14] = ft_strdup("10011111111001001000000001000001");
   map[15] = ft_strdup("10000010000001001001111001001111");
   map[16] = ft_strdup("10000010000101001101001001000001");
   map[17] = ft_strdup("111100100101010S1001000001000001");
   ...
   map[31] = ft_strdup("10001000010000000100001001001001");
