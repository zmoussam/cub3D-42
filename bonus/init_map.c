...
/*   Updated: 2023/03/01 04:56:50 by zmoussam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{   
   ...
   map[1] =  ft_strdup("10000000000001000000111111111111");
   map[2] =  ft_strdup("100000000000010000001");
   map[3] =  ft_strdup("10011111111000100100111");
   map[4] =  ft_strdup("10010000001000000001001111111111");
   ...
   map[11] = ft_strdup("11110010001000001000001001111111");
   map[12] = ft_strdup("1000111001111001001001001");
   map[13] = ft_strdup("10000010000001001001101011111111");
   map[14] = ft_strdup("100111111110010E1000000000000001");
   map[15] = ft_strdup("10000010111111111111111111111111");
   map[16] = ft_strdup("101000001          1");
   map[17] = ft_strdup("111100101          1111111111111");
   map[18] = ft_strdup("1000001001111111111001111001001");
